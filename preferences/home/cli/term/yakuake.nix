...
in {
  home = {
    ...
    file = {
      ".local/share/konsole/default.keytab".source = ./default.keytab;
      ".local/share/konsole/termix.profile".source = ./termix.profile;
      ".local/share/konsole/termix.colorscheme".text = ''
        [Background]
        Color=27,41,50
        RandomHueRange=360
      ...
      '';
      ".local/share/konsole/termix-bg.png".source = ./termix-bg.png;
      ".npmrc".text = ''
